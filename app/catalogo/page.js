    ...
    <main className="conteudo">
      <div className="container-catalogo">
        ...
        <div className="card card-roma">
          ...
          <div className="card-conteudo">
            ...
            <p className="sinopse">
              Durante a Idade Média, uma pequena capela no coração de Roma torna-se
              palco de um milagre.
            </p>
      ...
      <div className="container">
        <div className="list-pesquisa">
          <ul className="list">
            <li className="list-item" onClick={() => setCategoria(CATEGORIAS.inspiracao)}>Inspiração</li>
            <li className="list-item" onClick={() => setCategoria(CATEGORIAS.historico)}>Histórico</li>
            <li className="list-item" onClick={() => setCategoria(CATEGORIAS.drama)}>Drama</li>
            <li className="list-item" onClick={() => setCategoria(CATEGORIAS.superacao)}>Superação</li>
            <li className="list-item" onClick={() => setCategoria(CATEGORIAS.religioso)}>Religioso</li>
            <li className="list-item" onClick={() => setCategoria(CATEGORIAS.aventura)}>Aventura</li>
          </ul>
        </div>
        ...
        <footer className="informacoes">
            <div className="informacoes-container">
                ...
                <div className="rede-sociais">
                    <a href="#redes-sociais-mobile" className="icon insta"><i className="fa-brands fa-square-instagram"></i></a>
                    <a href="#redes-sociais-mobile" className="icon face"><i className="fa-brands fa-facebook-f"></i></a>
                    <a href="#redes-sociais-mobile" className="icon twitter"><i className="fa-brands fa-twitter"></i></a>
                    <a href="#redes-sociais-mobile" className="icon mail"><i className="fa-solid fa-envelope"></i></a>
                </div>
