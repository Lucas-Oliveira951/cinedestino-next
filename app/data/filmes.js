...
export const filmes = [
  // Catálogo Principal
  {
    ...
    background:
      "/filmes-background/caminho-da-luz/Caminho\ da\ Luz\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },
...

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/chama-do-perdao/_Chama\ do\ Perdão\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/o-peregrino-de-assis/O\ Peregrino\ de\ Assis\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/o-silencio-do-mosteiro/O\ Silêncio\ do\ Mosteiro\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/lagrimas-de-esperanca/Lágrimas\ de\ Esperança\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/sob-o-manto-da-virgem/Sob\ o\ Manto\ da\ Virgem\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/as-pegadas-de-pedro/As\ Pegadas\ de\ Pedro-\ background\ \(Desktop\ \ Versão\).jpg",
  },

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/a-ultima-capela/A\ Última\ Capela\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },

  {
    ...
    ano: "2025",
    background:
      "/filmes-background/entre-rosarios-e-estrelas/Entre\ Rosários\ e\ Estrelas\ -\ background\ \(Desktop\ \ Versão\).jpg",
  },
];
