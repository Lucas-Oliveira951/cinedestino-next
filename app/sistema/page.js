      ...
      <main className="conteudo">
        <div className="apresentacao">
            ...
            <div className="barra-de-pesquisa">
                <div className="barra-input"><input type="search" name="Pesquisar" id="Pesquisar" placeholder="Pesquisar"/><i
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/o-milagre-em-roma">
                            <img 
                              src="/../assets/Image/O Milagre em Roma.jpg" alt="O Milagre em Roma"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/chama-do-perdao">
                            <img 
                              src="/../assets/Image/Chama do Perdão.jpg" alt="Chama do Perdão"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/o-peregrino-de-assis">
                            <img 
                              src="/../assets/Image/O Peregrino de Assis.jpg" alt="O Peregrino de Assis"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/o-silencio-do-mosteiro">
                            <img 
                              src="/../assets/Image/O Silêncio do Mosteiro.jpg" alt="O Silêncio do Mosteiro"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/lagrimas-de-esperanca">
                            <img 
                              src="/../assets/Image/Lágrimas de Esperança.jpg" alt="Lágrimas de Esperança"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/sob-o-manto-da-virgem">
                            <img 
                              src="/../assets/Image/Sob o Manto da Virgem.jpg" alt="Sob o Manto da Virgem"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/as-pegadas-de-pedro">
                            <img 
                              src="/../assets/Image/As Pegadas de Pedro.jpg" alt="As Pegadas de Pedro"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/a-ultima-capela">
                            <img 
                              src="/../assets/Image/A Última Capela.jpg" alt="A Última Capela"
                ...
                <div className="filme-card">
                    <div className="poster">
                        <a href="/filmes/entre-rosarios-e-estrelas">
                            <img 
                              src="/../assets/Image/Entre Rosários e Estrelas.jpg" alt="Entre Rosários e Estrelas"
                ...
                <div className="filme-card-mobile">
                    <div className="poster-mobile">
                        <a href="/filmes/Caminho-da-Luz">
                            ...
                            <img 
                              src="/../assets/Image/Caminho da Luz.jpg" alt="Caminho da Luz"
                              title="Caminho da Luz (Criador por Gemni IA e Chat GPT)"
                            />
                        </a>
                    </div>
